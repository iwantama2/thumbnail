...
function code_convert(c) {
  ...
  1 == document.getElementById("lnk_check").checked && (a = a.replace(/https:\/\/draft.blogger.com\/blogger.g\?blogID=6961245121648530002/gi, ""), a = a.replace(/rel='nofollow'/gi, "rel='nofollow noopener'"), a = a.replace(/rel="nofollow"/gi, "rel='nofollow noopener noreferer'"), a = a.replace(/<a href=".*?" imageanchor.*?>(.*?)<\/a>/gi, "$1"), a = a.replace(/<p><\/p>/gi, ""), a = a.replace(/<span style="font-family:.*?>(.*?)<\/span>/gi, "<code>$1</code>"));
